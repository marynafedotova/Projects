...
function task8() {
  ...
  resultDiv.innerHTML = "Додатні: " + positiveCount + "<br>" + "Від'ємні: " + negativeCount + "<br>" + "Нулі: " + zeroCount + "<br>" + "Парні: " + evenCount + "<br>" + "Непарні: " + oddCount;
} //9
...
function task9() {
  ...
  do {
    ...
    answer = confirm("".concat(currenDayName, ". \u041F\u043E\u043A\u0430\u0437\u0430\u0442\u0438 \u043D\u0430\u0441\u0442\u0443\u043F\u043D\u0438\u0439 \u0434\u0435\u043D\u044C?"));
...
function task12() {
  var dayIn = parseInt(document.getElementById("day").value),
  ...
  resultDiv.innerHTML = "\u041D\u0430\u0441\u0442\u0443\u043F\u043D\u0430 \u0434\u0430\u0442\u0430: ".concat(dayOut, "/").concat(monthOut, "/").concat(yearOut);
}